...
$sql = "SELECT count(writer) FROM $searchapp WHERE category1 = '계정' or category2 ='계정' or category3 = '계정'";
$result = mysqli_query($conn, $sql);
$row = mysqli_fetch_array($result);
$g_d0 = $row['count(writer)'];

$sql = "SELECT count(writer) FROM $searchapp WHERE category1 = '아이디' or category2 = '아이디' or category3 = '아이디'";
$result = mysqli_query($conn, $sql);
$row = mysqli_fetch_array($result);
$g_d1 = $row['count(writer)'];

$sql = "SELECT count(writer) FROM $searchapp WHERE category1 = '연동' or category2 = '연동' or category3 = '연동'";
$result = mysqli_query($conn, $sql);
$row = mysqli_fetch_array($result);
$g_d2 = $row['count(writer)'];

$sql = "SELECT count(writer) FROM $searchapp WHERE category1 = '로그인' or category2 = '로그인' or category3 = '로그인'";
$result = mysqli_query($conn, $sql);
$row = mysqli_fetch_array($result);
$g_d3 = $row['count(writer)'];

$sql = "SELECT count(writer) FROM $searchapp WHERE category1 = '가입' or category2 = '가입' or category3 = '가입'";
$result = mysqli_query($conn, $sql);
$row = mysqli_fetch_array($result);
    ...
    <body>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">[계정] 하위 카테고리</h6>
            </div>
            <div class="card-body">
                <h4 class="small font-weight-bold">계정
                ...
                <h4 class="small font-weight-bold">아이디
                ...
                <h4 class="small font-weight-bold">연동
                ...
                <h4 class="small font-weight-bold" >로그인
                ...
                <h4 class="small font-weight-bold">가입
