...
$sql = "SELECT count(writer) FROM $searchapp WHERE category1 = '구성' or category2 ='구성' or category3 = '구성'";
$result = mysqli_query($conn, $sql);
$row = mysqli_fetch_array($result);
$g_d0 = $row['count(writer)'];

$sql = "SELECT count(writer) FROM $searchapp WHERE category1 = '이벤트' or category2 = '이벤트' or category3 = '이벤트'";
$result = mysqli_query($conn, $sql);
$row = mysqli_fetch_array($result);
$g_d1 = $row['count(writer)'];

$sql = "SELECT count(writer) FROM $searchapp WHERE category1 = '퀘스트' or category2 = '퀘스트' or category3 = '퀘스트'";
$result = mysqli_query($conn, $sql);
$row = mysqli_fetch_array($result);
$g_d2 = $row['count(writer)'];

$sql = "SELECT count(writer) FROM $searchapp WHERE category1 = '스테이지' or category2 = '스테이지' or category3 = '스테이지'";
$result = mysqli_query($conn, $sql);
$row = mysqli_fetch_array($result);
$g_d3 = $row['count(writer)'];

$sql = "SELECT count(writer) FROM $searchapp WHERE category1 = '난이도' or category2 = '난이도' or category3 = '난이도'";
$result = mysqli_query($conn, $sql);
$row = mysqli_fetch_array($result);
    ...
    <body>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">[구성] 하위 카테고리</h6>
            </div>
            <div class="card-body">
                <h4 class="small font-weight-bold">구성
                ...
                <h4 class="small font-weight-bold">이벤트
                ...
                <h4 class="small font-weight-bold">퀘스트
                ...
                <h4 class="small font-weight-bold" >스테이지
                ...
                <h4 class="small font-weight-bold">난이도
