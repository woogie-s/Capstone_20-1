...
$sql = "SELECT count(writer) FROM $searchapp WHERE category1 = '서버' or category2 = '서버' or category3 = '서버'";
$result = mysqli_query($conn, $sql);
$row = mysqli_fetch_array($result);
$g_d0 = $row['count(writer)'];

$sql = "SELECT count(writer) FROM $searchapp WHERE category1 ='연결' or category2 = '연결' or category3 = '연결'";
$result = mysqli_query($conn, $sql);
$row = mysqli_fetch_array($result);
$g_d1 = $row['count(writer)'];

$sql = "SELECT count(writer) FROM $searchapp WHERE category1 = '접속' or category2 = '접속' or category3 = '접속'";
$result = mysqli_query($conn, $sql);
$row = mysqli_fetch_array($result);
$g_d2 = $row['count(writer)'];

$sql = "SELECT count(writer) FROM $searchapp WHERE category1 = '로딩' or category2 = '로딩' or category3 = '로딩'";
$result = mysqli_query($conn, $sql);
$row = mysqli_fetch_array($result);
$g_d3 = $row['count(writer)'];

$sql = "SELECT count(writer) FROM $searchapp WHERE category1 = '네트워크' or category2 = '네트워크' or category3 = '네트워크'";
$result = mysqli_query($conn, $sql);
$row = mysqli_fetch_array($result);
    ...
    <body>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">[서버] 하위 카테고리</h6>
            </div>
            <div class="card-body">
                <h4 class="small font-weight-bold">서버
                ...
                <h4 class="small font-weight-bold">연결
                ...
                <h4 class="small font-weight-bold">접속
                ...
                <h4 class="small font-weight-bold" >로딩
                ...
                <h4 class="small font-weight-bold">네트워크
